...
class SendBookingConfirmationAdapterTest {
    ...
    void shouldSendBookingConfirmation() {
        ...
        assertThat(simpleMailMessageArgumentCaptor.getValue().getTo()).contains(email);
        assertThat(simpleMailMessageArgumentCaptor.getValue().getSubject()).isEqualTo("Booking confirmation");
        assertThat(simpleMailMessageArgumentCaptor.getValue().getText()).isEqualTo("" +
            "MY HEX THAI STAR\n" +
            "Hi john@example.com\n" +
